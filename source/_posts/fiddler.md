...
![](https://s.poetries.top/gitee/2019/10/187.png)
![](https://s.poetries.top/gitee/2019/10/188.png)
...
![](https://s.poetries.top/gitee/2019/10/189.png)

二、HTTP请求图标说明
---

![](https://s.poetries.top/gitee/2019/10/190.png)
![](https://s.poetries.top/gitee/2019/10/191.png)
...
![](https://s.poetries.top/gitee/2019/10/192.png)
...
![](https://s.poetries.top/gitee/2019/10/193.png)
...
![](https://s.poetries.top/gitee/2019/10/194.png)


- 方法二：选中工具栏中的"Decode"。  这样会自动解压缩

![](https://s.poetries.top/gitee/2019/10/195.png)
...
![](https://s.poetries.top/gitee/2019/10/196.png)

- 选择`Fiddler`右侧`reponse`块下的`TextView`，这里修改`title`,如图：

![](https://s.poetries.top/gitee/2019/10/197.png)

- 去掉`“Unlock for Editing”`，再选择右侧上方的`AutoResponder`,勾选下方的`checkbox`选框，并将序号`16`托到下方，同时，里面会多条记录，如下图：

![](https://s.poetries.top/gitee/2019/10/198.png)


- 回到浏览器，刷新页面，如图，标题变为上面改的内容

![](https://s.poetries.top/gitee/2019/10/199.png)
...
![](https://s.poetries.top/gitee/2019/10/200.png)
...
![](https://s.poetries.top/gitee/2019/10/201.png)
...
![](https://s.poetries.top/gitee/2019/10/202.png)
![](https://s.poetries.top/gitee/2019/10/203.png)
...
![](https://s.poetries.top/gitee/2019/10/204.png)
![](https://s.poetries.top/gitee/2019/10/205.png)
...
![](https://s.poetries.top/gitee/2019/10/206.png)

- 接着点击保存即可~ 这样在需要的时候可以切换到`Fiddler`

![](https://s.poetries.top/gitee/2019/10/207.png)