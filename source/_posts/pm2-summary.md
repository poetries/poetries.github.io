...
![](https://s.poetries.top/gitee/2019/10/395.png)

- `pm2 describe id` 查看启动程序的详细信息

![](https://s.poetries.top/gitee/2019/10/396.png)

- `$ pm2 monit` 监视每个`node`进程的`CPU`和内存的使用情况

![](https://s.poetries.top/gitee/2019/10/397.png)

- `$ pm2 logs` 显示所有进程日志

![](https://s.poetries.top/gitee/2019/10/398.png)

- 强大API： `pm2 web`

> 你想要监控所有被`PM2`管理的进程,而且同时还想监控运行这些进程的机器的状态

![](https://s.poetries.top/gitee/2019/10/399.png)
...
![](https://s.poetries.top/gitee/2019/10/400.png)
