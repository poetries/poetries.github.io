---
title: Bun 被 Anthropic 收购后 AI 编码时代的 JS 运行时怎么选
description: Anthropic 收购 Bun 之后，JavaScript 运行时格局会怎么变。梳理收购背景、Bun 的技术路线与性能来源、开源承诺的可信度，以及现阶段要不要把 Bun 用进生产项目的判断依据。
...
这件事也不只是 Anthropic 的需求。GitHub Copilot、Cursor、Replit 这些产品都会撞上同一堵墙。想深入了解 Claude 这套工具体系是怎么组织能力的，可以顺带看看我写的 [Claude Skills 如何将提示词升级为可复用技能](https://feinterview.poetries.top/blog/claude-skills)。
...
- [Bun joins Anthropic 官方公告](https://bun.com/blog/bun-joins-anthropic)
- [Bun 官方文档](https://bun.com/docs)
- [Bun 的 Node.js 兼容性说明](https://bun.com/docs/runtime/nodejs-apis)
