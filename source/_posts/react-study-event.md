...
![](https://s.poetries.top/gitee/2019/10/456.png)

- 在函数体中进行一些操作，常见的有：更新页面内容，更新组件状态，与后台交互

![](https://s.poetries.top/gitee/2019/10/457.png)
...
![](https://s.poetries.top/gitee/2019/10/458.png)


- 键盘：键盘事件拥有的事件属性

![](https://s.poetries.top/gitee/2019/10/459.png)

- 鼠标：鼠标事件拥有的事件属性

![](https://s.poetries.top/gitee/2019/10/460.png)

- 滚动：滚动事件拥有的事件属性
  - 为什么会有三个，因为有的设备可以实现三个方向的移动
  
![](https://s.poetries.top/gitee/2019/10/461.png)
